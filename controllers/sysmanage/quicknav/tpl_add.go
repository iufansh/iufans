            ...
            <div class="layui-tab layui-tab-brief">
                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show">
                        <form class="layui-form form-container" action='{{.urlQuickNavAddPost}}'
                              method="post">
                        	{{.xsrfdata}}
                            <div class="layui-form-item">
                                <label class="layui-form-label">名称</label>
                                <div class="layui-input-block">
                                    <input type="text" name="Name" placeholder="请输入显示名称" required lay-verify="required"
                                           class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="WebSite" placeholder="请输入完整网址，如：http://www.baidu.com" required
                        ...
                        -->
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="number" name="Seq" placeholder="请输入排序，必须为数字" required lay-verify="required"
                                           class="layui-input">
                                </div>
