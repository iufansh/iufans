        ...
        <div class="layui-col-xs12 layui-col-sm12 layui-col-md12">
            ...
            <div class="layui-tab layui-tab-brief">
                <ul class="layui-tab-title">
                    ...
                    <li class="layui-this">添加App版本</li>
                </ul>
                    ...
                    <div class="layui-tab-item layui-show">
                        <form class="layui-form form-container" action='{{.urlAppVersionAddPost}}' method="post">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="AppNo" placeholder="App编号，每个App编号唯一" class="layui-input">
                                </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="number" name="VersionNo" placeholder="必须为整数，如：1" required lay-verify="required"
                                           class="layui-input">
                                </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="VersionName" placeholder="如：v1.0" required lay-verify="required"
                                           class="layui-input">
                                </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="PublishTime" value="" required lay-verify="required" class="layui-input">
                                </div>
							...
							<div class="layui-form-item">
								...
								<div class="layui-input-inline">
									<input type="radio" name="ForceUpdate" value="0" title="可选" checked="checked">
									<input type="radio" name="ForceUpdate" value="1" title="强制">
								</div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <textarea name="VersionDesc" rows="5" placeholder="1.提升稳定性；2.优化UI" class="layui-textarea"></textarea>
                                </div>
                            </div>
							<fieldset class="layui-elem-field">
							  	...
							  	<div class="layui-field-box">
									...
									<div class="layui-form-item">
										...
										<div class="layui-input-block">
											<input type="text" id="downloadUrl" name="DownloadUrl" placeholder="请输入完整网址，如：http://www.baidu.com" required
									...
									<div class="layui-form-item">
										...
										<div class="layui-input-inline">
											<input type="number" id="appSize" name="AppSize" value="" required lay-verify="required" class="layui-input">
										</div>
									...
									<div class="layui-form-item">
										...
										<div class="layui-input-block">
											<input type="text" id="encryptValue" name="EncryptValue" value="" placeholder="安装包加密校验值，一般为Md5" class="layui-input">
										</div>
									</div>
							  	</div>
							</fieldset>
